...
class _AppShell extends StatelessWidget {
  ...
  static const _destinations = [
    ...
    _Dest(HugeIcons.strokeRoundedSquare, HugeIcons.strokeRoundedSquare, 'Tugasan', '/tasks'),
    _Dest(HugeIcons.strokeRoundedSquare, HugeIcons.strokeRoundedSquare, 'Loyalty', '/loyalty'),
    _Dest(HugeIcons.strokeRoundedSquare, HugeIcons.strokeRoundedBadge, 'Staf', '/staff'),
    ...
    _Dest(HugeIcons.strokeRoundedSquare, HugeIcons.strokeRoundedSquare, 'Multi-Outlet', '/outlets'),
    _Dest(HugeIcons.strokeRoundedSquare, HugeIcons.strokeRoundedSquare, 'Delivery Hub', '/delivery'),
    _Dest(HugeIcons.strokeRoundedSquare, HugeIcons.strokeRoundedSquare, 'Analitik Lanjutan', '/analytics'),
    ...
    _Dest(HugeIcons.strokeRoundedSquare, HugeIcons.strokeRoundedBarChart, 'Laporan', '/reports'),
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: [
          ...
          const NavigationDestination(
            ...
            selectedIcon: HugeIcon(icon: HugeIcons.strokeRoundedSquare),
            label: 'Lain-lain',
          ),
        ],
      ),
