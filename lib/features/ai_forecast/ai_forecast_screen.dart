      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 4),
                        Text(
                          'Berdasarkan data jualan 30 hari lepas.',
            ...
            const Text(
              'Cadangan Pesanan Bekalan (Minggu Ini)',
              style: TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.bold,
                color: AppTheme.darkEspresso,
            ...
            Expanded(
              child: ListView(
                children: [
                  _buildForecastItem(
                    'Biji Kopi Arabica (Brazil)',
                    'Tinggal 5kg. Jangkaan habis dalam 3 hari.',
                    'Pesan 20kg',
                    HugeIcons.strokeRoundedCoffee01,
                    Colors.brown,
                  ),
                  _buildForecastItem(
                    'Susu Segar (Farm Fresh)',
                    'Permintaan tinggi hujung minggu.',
                    'Pesan 15 Karton',
